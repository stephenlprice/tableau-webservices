...
```python
# Austin
https://api.openweathermap.org/data/2.5/weather?lat=30.2711286&lon=-97.7436995&appid=API_KEY
```
...
```python
# Austin
https://api.openweathermap.org/data/2.5/forecast?lat=30.2711286&lon=-97.7436995&appid=API_KEY
```
